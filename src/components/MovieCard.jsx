...
export default function MovieCard({ movie, onToggleWatchlist, isInWatchlist }) {
  ...
  return (
    <div className="group/card relative w-[320px] sm:w-[380px] md:w-[420px] lg:w-[480px] card-hover">
      <Link to={`/movie/${movie.id}`} className="block relative overflow-hidden rounded-md aspect-video">
        {/* Backdrop image */}
        <img
          src={backdrop}
          alt={movie.title}
        ...
        {/* Default state: subtle bottom gradient */}
